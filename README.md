...
3. Dynamic Titration Curve Visualization
The program automatically simulates 300 data points to generate a smooth pH curve. It strategically marks the "Equivalence Points" with red dots, allowing you to visualize exactly when the chemical neutralization is complete.
